...
El comando **ip** es una actualización del comando ifconfigutilizado en la mayoría de las distribuciones modernas.
...
> La configuración aplicada por el comando ipes provisional. Si queremos que los cambios se mantengan al reiniciar el equipo hay que usar la herramienta netplan.
