...
> * ntfs no es nativo de Linux y puede garantizarse la plena compatibilidad para usar en SO Windows.
...
![](media/partition_mbr.png)

- En **GPT** las particiones se numeran de 1 a n.

![](media/partition_gpt.png)
...
![](media/android_partitioning.png)
...
Por ejemplo, para montar una imagen de CD:
...
Pasos para el montaje y formateo de un disco desde su creación:
...
3.  Darle **formato** al disco en */dev/sd\** usando el comando mkfs y el sistema de archivos:
    *sudo mkfs –t ext4 /dev/sdb*

4. Crear la carpeta o directorio en *mnt* donde desees montar dicho disco:
*sudo mkdir /mnt/midisco*

5. Proceder al **montaje** del disco en dicha carpeta volviendo a indicar el sistema de archivos:
...
-   Las nombradas de la 1 a la 4 son particiones **primarias** (o una extendida)
